...
public class PatientDataBuilderTest {
    ...
    public void setup() {
        ...
        this.daoConfiguration = new ResourceDaoConfiguration(null, null, null, null, this.organizationDao, null, this.practitionerDao, this.practitionerRoleDao, null, null, null);
